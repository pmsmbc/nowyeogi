...
- 글의 성격은 "직접 방문 후기"가 아니라 "공개 자료를 정리한 여행 정보"로 확정(2026-09-09, 사용자 확인). 모든 글에 AI 도움·비방문 안내와 참고 자료(`sources`)를 표시하고, note.txt에 `출처:` 항목을 둔다. 소개 페이지·스킬 규칙·README 콘텐츠 원칙에 반영.
