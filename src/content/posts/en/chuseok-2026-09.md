---
title: "Chuseok 2026 in Korea: What Is Open and What Is Closed"
description: "The 2026 Chuseok holiday runs four days, 24 to 27 September. When the palaces and national museums open, when department stores and banks shut, and why the subway runs late on only two of the four nights — all checked against official notices."
pubDate: 2026-09-16
scope: domestic
region: seoul
type: travel
...
images:
  - src: /images/chuseok-2026-09/01.webp
    alt: "Heungnyemun Gate and the wide forecourt of Gyeongbokgung Palace, with visitors in hanbok walking past"
    width: 940
    height: 627
    credit: "Korea Tourism Organization (KOGL Type 1)"
    creditUrl: "https://kto.visitkorea.or.kr/"
  - src: /images/chuseok-2026-09/10.webp
    alt: "A charye ancestral rite table set before a folding screen, with rice and soup, pan-fried dishes and fish, and pears and apples stacked in tiers"
    width: 1600
    height: 1200
  ...
  - src: /images/chuseok-2026-09/11.webp
    alt: "Two people in hanbok standing in front of Gyeonghoeru pavilion at Gyeongbokgung, with the pond and Inwangsan behind them"
    width: 1600
    height: 1176
  ...
  - src: /images/chuseok-2026-09/05.webp
    alt: "Rows of white, pink and mugwort-green songpyeon rice cakes in a wooden box, laid on pine needles"
    width: 1600
    height: 1294
    credit: "wizdata, CC0, via Wikimedia Commons"
    creditUrl: "https://commons.wikimedia.org/wiki/File:Songpyeon.jpg"
tags: ["Chuseok", "Korean holidays", "palace free admission", "Seoul travel", "September in Seoul"]
places: []
sources:
  - { title: "Korean Law Information Center — Presidential Decree on Public Holidays for Government Offices", url: "https://www.law.go.kr/%EB%B2%95%EB%A0%B9/%EA%B4%80%EA%B3%B5%EC%84%9C%EC%9D%98%EA%B3%B5%ED%9C%B4%EC%9D%BC%EC%97%90%EA%B4%80%ED%95%9C%EA%B7%9C%EC%A0%95" }
  - { title: "Seoul Metropolitan Government — 2026 Chuseok comprehensive plan", url: "https://www.seoul.go.kr/news/news_report.do?bbsNo=158&nttNo=466247" }
  - { title: "Royal Palaces and Tombs Center — visitor information", url: "https://royal.khs.go.kr/ROYAL/contents/R702000000.do" }
  - { title: "Royal Palaces and Tombs Center — hanbok free admission guidelines", url: "https://royal.khs.go.kr/ROYAL/contents/R705000000.do" }
  - { title: "National Museum of Korea — visitor information", url: "https://www.museum.go.kr/MUSEUM/contents/M0101000000.do" }
...
Restaurants and department stores close, but **the palaces and national museums stay open**, and Seoul empties out. All of this is checked against official notices, as of 16 September 2026.

![Heungnyemun Gate and the wide forecourt of Gyeongbokgung Palace, with visitors in hanbok walking past](/images/chuseok-2026-09/01.webp)
...
- **Item 1**: a Saturday overlap generates one only for the national days, Buddha's Birthday, Children's Day, Labour Day and Christmas Day.

No Chuseok day falls on a Sunday in 2026, so **there is no substitute holiday**. The 27th is a holiday only because it is a Sunday, and **Monday the 28th is an ordinary working day**. Seoul's press release agrees: four days, three shorter than last year.

## The palaces are open all four days
...
- **National Palace Museum of Korea** — closed the 25th; it adjoins Gyeongbokgung, so plan around that date.
- **National Museum of Modern and Contemporary Art** — only the Seoul branch closes on the 25th. **Gwacheon, Deoksugung and Cheongju open all four days, free.**

## Events you can join without Korean

![A charye ancestral rite table set before a folding screen, with rice and soup, pan-fried dishes and fish, and pears and apples stacked in tiers](/images/chuseok-2026-09/10.webp)
...
### Department stores — it varies by branch

**Every Seoul department store closes on 25 September**, and each takes a second day too — not the same one.

| Department store | Closed |
| --- | --- |
| Lotte (main, Jamsil, Gangnam, Yeongdeungpo etc.) | 24 Sep, 25 Sep |
| Shinsegae **main store (Myeongdong)** | **25 Sep, 26 Sep** |
| Shinsegae Gangnam, Times Square | 24 Sep, 25 Sep |
| Hyundai The Hyundai Seoul, Trade Center, Mokdong | 24 Sep, 25 Sep |
| Hyundai **Apgujeong main store, Sinchon** | **25 Sep, 26 Sep** |

Myeongdong needs care: **Lotte main closes on the 24th and 25th, Shinsegae main on the 25th and 26th.** The only day both open is Sunday the 27th.
...
**AREX** likewise extends last-service sections on **26 and 27 September only**: the 23:50 from Incheon Airport Terminal 2 runs through to Seoul Station, arriving 00:57, and the 00:00 from Seoul Station runs through to Terminal 2, arriving 01:07.
...
![Rows of white, pink and mugwort-green songpyeon rice cakes in a wooden box, laid on pine needles](/images/chuseok-2026-09/05.webp)

- **Seoul gets quieter** as residents leave for their hometowns — one of the best weeks of the year for palaces and museums.
- **Only one date really needs working around: 25 September**, when three national museums and every department store close.
- **Check restaurants ahead.** The smaller and more owner-run, the likelier it closes; chains and hotel restaurants generally open.
- **Songpyeon** is the half-moon rice cake eaten at Chuseok — rice dough stuffed with sesame, beans or chestnut, steamed on pine needles. On sale from the week before.
- **Carry cash.** Bank counters are shut all four days; ATMs work, but exchanging money away from an airport is difficult.
- Seoul runs a **2026 Chuseok information website** from 16 September, and will police **taxi overcharging of foreign passengers** in Myeongdong, Hongdae and Gangnam on 23 and 27 September.
